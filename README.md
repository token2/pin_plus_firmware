...
The relevant PIN validation logic in [`CustomFunction.java`](https://github.com/token2/pin_plus_firmware/blob/f016204df9552f7bdf07183a5ca380118a90559e/src/CustomFunction.java#L3) has been updated accordingly ( any non-ASCII characters are treated as their own class ).
