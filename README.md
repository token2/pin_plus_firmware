...
The relevant PIN validation logic in [`CustomFunction.java`](https://github.com/token2/pin_plus_firmware/src/CustomFunction.java#L5) has been updated accordingly ( any non-ASCII characters are treated as their own class ).
